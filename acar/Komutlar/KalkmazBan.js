...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let embed = new MessageEmbed().setColor('0x2f3136').setTitle(`Yıkılmayan Ban`).setAuthor(acar.Tag + " " + acar.sunucuIsmi, message.guild.iconURL({dynamic: true, size: 2048}))
